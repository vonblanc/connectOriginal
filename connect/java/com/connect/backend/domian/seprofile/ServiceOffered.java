...
public class ServiceOffered{
    ...
    public Key<Profile> getParentKey(){return profileKey;}
	
	public String getServiceName(){return serviceName;}
	public String getServiceCategory(){return serviceCategory;}                              //get member variables 
	public double getServicePrice(){return servicePrice;}
	public double getEstTime(){return estTime;}
	public String getServiceDescription(){return serviceDescription==null ? "Service Offered needs a description":this.serviceDescription;}
	public String getWebSafeServiceOfferedKey(){return Key.create(profileKey,ServiceOffered.class,this.ID).getString();}
